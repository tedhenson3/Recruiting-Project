...
url_247 <- c("https://247sports.com/Season/2019-Football/CompositeRecruitRankings/?InstitutionGroup=highschool&PositionGroup=QB")
...
write.csv(rankings.247, file = 'qb.rankings.247.csv', row.names = F)
